...
def parseArguments():
    ...
    parser.add_argument("-us", "--update_timestep",                 default=5000,   type=int,           help="number of steps until update (n_steps/update_timestep) e.g. max_ep_len * 4")
    ...
    parser.add_argument("-e_clip", "--epsilon_clip",                default=0.2,    type=float,         help="should probably be between [0.1, 0.3]")
    ...
    parser.add_argument("-a_std_freq", "--action_std_decay_freq",   default=5e3,    type=int,           help="action standard deviation decay frequency")
